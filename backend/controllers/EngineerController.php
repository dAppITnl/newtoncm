...
class EngineerController extends Controller
{
     ...
     */
    public function actionView($eng_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($eng_id),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'eng_id' => $model->eng_id]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($eng_id)
    {
        $model = $this->findModel($eng_id);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($eng_id)
    {
        $this->findModel($eng_id)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($eng_id)
    {
        if (($model = Engineer::findOne(['eng_id' => $eng_id])) !== null) {
            return $model;
        }
